...
trainset = torchvision.datasets.ImageFolder(root='../CSCEN/',
...
for i,data in enumerate(train_dataloader):
    ...
    for j in range(0,12):
        ...
        # img2 = img2_aug.detach().cpu().float().numpy()
        ...
        # torchvision.utils.save_image(mix,'../Data_FMix_AICD/{}/{}png'.format(subdir,filename))
