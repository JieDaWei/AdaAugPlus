...
def get_args():
    ...
    parser.add_argument('--project_name', default='CD_EGYBCD_RLAT8Epoch3Tanh250', type=str)
    parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
    parser.add_argument('--checkpoint_root', default='checkpoints/EGYBCD_RLAT8Epoch3Tanh250/', type=str)
    parser.add_argument('--output_folder', default='samples/EGYBCD_RLAT8Epoch3Tanh250', type=str)

    # data
    parser.add_argument('--num_workers', default=8, type=int)
    parser.add_argument('--dataset', default='CDDataset', type=str)
    parser.add_argument('--data_name', default='EGYBCD', type=str)
