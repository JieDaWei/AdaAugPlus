...
if __name__ == '__main__':
    ...
    #A2C
    parser.add_argument('--action_num', default=8, type=int)
    parser.add_argument('--reduce_rate', default=220, type=float)
    parser.add_argument('--data_path', default="/home/cver2080/4TDISK/wjd/datasets/BCD/list/trainval2.txt", type=str)
